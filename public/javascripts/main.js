...
function changeProgress(progress) {
    return function (dispatch, getState) {
        var pause = getState().pause;
        var duration = getState().duration;
...
function changeVolume(progress) {
    return function (dispatch, getState) {
...
function next() {
    return function (dispatch, getState) {
        var state = getState();
        var music = getMusic(state, 'next'); //得到下一首的歌
...
function prev() {
    return function (dispatch, getState) {
        var state = getState();
        var music = getMusic(state, 'prev'); //得到上一首的歌
        $('#player').jPlayer('setMedia', { mp3: '/music/' + music.file }).jPlayer(state.pause ? 'pause' : 'play');
        dispatch({
            type: 'NEXT',
            currentMusic: music
...
function changePlayType() {
    return function (dispatch, getState) {
        var changeType = getState().playType === 'repeat' ? 'random' : 'repeat';
        dispatch({
...
function getMusic(state) {
    var nextOrPrev = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'next';
    //得到下一首或上一首歌
    if (state.playType === 'repeat') {
        var music_list = state.musicList;
        var id = (music_list.indexOf(state.currentMusic) + (nextOrPrev === 'next' ? 1 : 5)) % music_list.length;
        return music_list[id];
    } else {
        var random_list = state.randomList;
        var _id = (random_list.indexOf(state.currentMusic) + (nextOrPrev === 'next' ? 1 : 5)) % random_list.length;
        return random_list[_id];
    }
}
...
function loadMusicList() {
    return function (dispatch, getState) {
        fetch('/music/getAll', { method: 'POST' }).then(function (response) {
...
var toCamelCase = __webpack_require__(90)
var cache = { 'float': 'cssFloat' }
var addPxToStyle = __webpack_require__(93)
...
fetch('/music/getAll', { method: 'POST' }).then(function (response) {
    ...
    var initState = {
        ...
        musicList: data,
        playType: 'repeat',
        randomList: (0, _player.random)(data),
        duration: 0,
        leftShow: false
    };
    return Promise.resolve(initState);
}).then(function (initState) {
    var store = (0, _redux.createStore)(_todo2.default, initState, (0, _redux.applyMiddleware)(_reduxThunk2.default));
...
var _playCon = __webpack_require__(44);

var _playCon2 = _interopRequireDefault(_playCon);

var _appCon = __webpack_require__(101);

var _appCon2 = _interopRequireDefault(_appCon);
    ...
    _createClass(Root, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                _appCon2.default,
                null,
                _react2.default.createElement(_playCon2.default, null)
            );
        }
    }]);
...
var _player2 = __webpack_require__(72);
...
function mapDispatchToProps(dispatch) {
    return {
        changeProgress: function changeProgress(progress) {
            dispatch((0, _player.changeProgress)(progress));
        },
        changeVolume: function changeVolume(progress) {
            dispatch((0, _player.changeVolume)(progress));
        },
        play: function play() {
            dispatch((0, _player.playOrPause)());
        },
        next: function next() {
            dispatch((0, _player.next)());
        },
        changeMute: function changeMute() {
            dispatch((0, _player.changeMute)());
        },
        prev: function prev() {
            dispatch((0, _player.prev)());
        },
        changePlayType: function changePlayType() {
            dispatch((0, _player.changePlayType)());
        },
        leftShowOrHide: function leftShowOrHide() {
            dispatch((0, _player.leftShowOrHide)());
        }
    };
}

var PlayerCon = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_player3.default);

exports.default = PlayerCon;
...
var _musicListCon = __webpack_require__(79);

var _musicListCon2 = _interopRequireDefault(_musicListCon);

var _reactCustomScrollbars = __webpack_require__(84);
...
var Player = function (_Component) {
    ...
    _createClass(Player, [{
        ...
        value: function calculateTime(time) {
            ...
            var formatTime = minute + ':' + (second < 10 ? '0' + second : second);
            return formatTime;
        }
    }, {
        key: 'render',
        value: function render() {
            var _props = this.props,
                leftShow = _props.leftShow,
                duration = _props.duration,
                playType = _props.playType,
                currentMusic = _props.currentMusic,
                ...
                next = _props.next,
                play = _props.play,
                changeMute = _props.changeMute,
                changeProgress = _props.changeProgress,
                changeVolume = _props.changeVolume,
                prev = _props.prev,
                changePlayType = _props.changePlayType,
                leftShowOrHide = _props.leftShowOrHide;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'clearfix volume-controll' },
                            _react2.default.createElement(
                                'div',
                                { className: 'volume-container' },
                                _react2.default.createElement('i', { className: 'fa fa-lg ' + (mute ? 'fa-volume-off' : 'fa-volume-up'), onClick: changeMute }),
                                _react2.default.createElement(
                                    'div',
                                    { className: 'volume-wrapper' },
                                    _react2.default.createElement(_progress2.default, { progress: volume, onProgressChange: changeVolume })
                                )
                            )
                        ),
                        _react2.default.createElement(
                            'div',
                            { className: 'time-controll clearfix' },
                            _react2.default.createElement(
                                'div',
                                { className: 'time nowTime' },
                                this.calculateTime(progress * duration / 100)
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'progress-wrapper' },
                                _react2.default.createElement(_progress2.default, { progress: progress, onProgressChange: changeProgress, barColor: 'red' })
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'time allTime' },
                                this.calculateTime(duration)
                            )
                        ),
                        _react2.default.createElement(
                            'div',
                            { className: 'play-controll-wrap clearfix' },
                            _react2.default.createElement(
                                'div',
                                { className: 'play-controll' },
                                _react2.default.createElement('i', { className: 'fa fa-angle-left fa-2x', onClick: prev }),
                                _react2.default.createElement('i', { className: 'fa ' + (!pause ? 'fa-pause' : 'fa-play') + ' fa-1x', onClick: play }),
                                _react2.default.createElement('i', { className: 'fa fa-angle-right fa-2x', onClick: next })
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'play-repeat' },
                                _react2.default.createElement('i', { onClick: changePlayType, className: 'fa ' + (playType === 'repeat' ? 'fa-repeat' : 'fa-random') + ' fa-2x' })
                            )
                        )
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'cover' },
                        _react2.default.createElement('img', { src: '/image/' + currentMusic.cover, alt: currentMusic.title })
                    )
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'left-list', style: { right: leftShow ? '0px' : '-310px' } },
                    _react2.default.createElement(
                        _reactCustomScrollbars.Scrollbars,
                        { autoHide: true, style: { width: 310, height: 500 } },
                        _react2.default.createElement(_musicListCon2.default, null)
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'toggleShow', onClick: leftShowOrHide },
                        _react2.default.createElement('i', { className: 'fa fa-angle-' + (leftShow ? 'right' : 'left') })
                    )
                )
            );
        }
...
var Progress = function (_Component) {
    ...
    function Progress(props) {
        ...
        _this.barColor = props.barColor || 'black';
        _this.changeProgress = _this.changeProgress.bind(_this);
        _this.refCb = _this.refCb.bind(_this);
        return _this;
    }
    ...
    _createClass(Progress, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'components-progress', ref: this.refCb, onClick: this.changeProgress },
                _react2.default.createElement('div', { className: 'progress', style: { width: this.props.progress + '%', background: this.barColor } })
            );
        }
    }]);
...
// module
exports.push([module.i, ".components-progress {\n  width: 100%;\n  height: 3px;\n  background: #ddd;\n  cursor: pointer;\n}\n.components-progress .progress {\n  width: 20%;\n  height: 3px;\n}\n", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./player.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./player.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".player-page {\n  position: relative;\n  min-width: 700px;\n  width: 100%;\n}\n.player-page .left-list {\n  transition: right 1s ease-in;\n  position: absolute;\n  top: 0px;\n}\n.player-page .left-list .toggleShow {\n  position: absolute;\n  width: 25px;\n  height: 45px;\n  background: rgba(36, 222, 96, 0);\n  top: 227px;\n  left: -25px;\n  cursor: pointer;\n  border-radius: 6px 0px 0px 6px;\n  font-size: 35px;\n}\n.player-page .left-list .toggleShow i {\n  margin-top: 5px;\n  margin-left: 5px;\n  color: rgba(36, 222, 96, 0.2);\n}\n.player-page .left-list .toggleShow:hover {\n  background: rgba(36, 222, 96, 0.4);\n}\n.player-page .left-list .toggleShow:hover i {\n  color: #24de60;\n}\n.player-page .caption {\n  text-align: center;\n  font-size: 17px;\n  color: #24de60;\n  margin-top: 10px;\n}\n.player-page .main-container {\n  margin-top: 100px;\n  width: 100%;\n}\n.player-page .main-container .controll-wrapper {\n  width: 40%;\n  float: left;\n  padding-left: 15%;\n}\n.player-page .main-container .controll-wrapper .music-title {\n  font-size: 30px;\n  font-weight: bold;\n  line-height: 60px;\n}\n.player-page .main-container .controll-wrapper .music-artist {\n  font-size: 15px;\n  line-height: 40px;\n}\n.player-page .main-container .controll-wrapper .volume-controll {\n  line-height: 30px;\n  color: rgba(3, 11, 2, 0.32);\n}\n.player-page .main-container .controll-wrapper .volume-controll .left-time {\n  float: left;\n  font-size: 10px;\n  line-height: 42px;\n}\n.player-page .main-container .controll-wrapper .volume-controll .volume-container {\n  float: left;\n}\n.player-page .main-container .controll-wrapper .volume-controll .volume-container i {\n  width: 20px;\n}\n.player-page .main-container .controll-wrapper .volume-controll .volume-container .volume-wrapper {\n  display: inline-block;\n  width: 100px;\n  margin-left: 10px;\n  margin-bottom: 4px;\n}\n.player-page .main-container .controll-wrapper .time-controll {\n  width: 100%;\n  margin-top: 20px;\n}\n.player-page .main-container .controll-wrapper .time-controll .time {\n  float: left;\n  font-size: 10px;\n  color: rgba(3, 11, 2, 0.32);\n}\n.player-page .main-container .controll-wrapper .time-controll .progress-wrapper {\n  float: left;\n  width: 78%;\n  margin: 5px 3px;\n}\n.player-page .main-container .controll-wrapper .play-controll-wrap {\n  margin-top: 30px;\n}\n.player-page .main-container .controll-wrapper .play-controll-wrap .play-controll {\n  float: left;\n  position: relative;\n}\n.player-page .main-container .controll-wrapper .play-controll-wrap .play-controll i {\n  margin: 0 13px;\n  cursor: pointer;\n}\n.player-page .main-container .controll-wrapper .play-controll-wrap .play-controll i:nth-child(2) {\n  font-size: 24px;\n}\n.player-page .main-container .controll-wrapper .play-controll-wrap .play-repeat {\n  float: right;\n  font-size: 15px;\n  cursor: pointer;\n}\n.player-page .main-container .cover {\n  width: 30%;\n  float: left;\n  padding-left: 10%;\n}\n.player-page .main-container .cover img {\n  margin-top: 30px;\n  width: 130px;\n  height: 130px;\n  border-radius: 65px;\n}\n", ""]);
...
var _musiclist = __webpack_require__(80);
...
function mapDispatchToProps(dispatch) {
    return {
        playThis: function playThis(music) {
            dispatch((0, _player.playThis)(music));
        }
    };
}
var MusicListCon = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_musiclist2.default);

exports.default = MusicListCon;
...
var _musicListItem = __webpack_require__(81);
...
var MusicList = function (_Component) {
    ...
    function MusicList(props) {
        ...
        return _possibleConstructorReturn(this, (MusicList.__proto__ || Object.getPrototypeOf(MusicList)).call(this, props));
    }
    ...
    _createClass(MusicList, [{
        ...
        value: function render() {
            var _props = this.props,
                musicList = _props.musicList,
                currentMusic = _props.currentMusic,
                playThis = _props.playThis;

            var listEle = musicList.map(function (item) {
                return _react2.default.createElement(_musicListItem2.default, { playThis: playThis, width: '300px', key: item.id, musicItem: item, focus: item.id === currentMusic.id });
            });
            return _react2.default.createElement(
                'ul',
                null,
...
var MusicListItem = function (_Component) {
    _inherits(MusicListItem, _Component);
    ...
    function MusicListItem(props) {
        ...
        _this.playMusic = _this.playMusic.bind(_this, _this.props.musicItem.id);
        _this.deleteMusic = _this.deleteMusic.bind(_this, _this.props.musicItem.id);
        return _this;
    }
    ...
    _createClass(MusicListItem, [{
        ...
        key: 'deleteMusic',
        value: function deleteMusic(musicId, evevt) {
            event.stopPropagation();
        ...
        value: function render() {
            var _props = this.props,
                focus = _props.focus,
                musicItem = _props.musicItem,
                playThis = _props.playThis;

            return _react2.default.createElement(
                'li',
                { style: { width: this.props.width }, onClick: playThis.bind(this, musicItem), className: 'components-musicListItem clearfix ' + (focus ? 'focus' : '') },
                _react2.default.createElement(
                    'p',
                    null,
                    _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { onClick: this.deleteMusic, className: 'delete' },
                    _react2.default.createElement('i', { className: 'fa fa-minus fa-2x' })
                )
            );
        }
    }]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./musicListItem.less", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/less-loader/dist/cjs.js!./musicListItem.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".components-musicListItem {\n  height: 40px;\n  border-bottom: 1px solid #cccccc;\n  line-height: 40px;\n  padding-left: 10px;\n  font-size: 15px;\n}\n.components-musicListItem p {\n  cursor: pointer;\n  float: left;\n}\n.components-musicListItem p strong {\n  font-weight: bold;\n}\n.components-musicListItem .delete {\n  cursor: pointer;\n  height: 100%;\n  float: right;\n  font-size: 15px;\n  margin-right: 30px;\n}\n.components-musicListItem .delete i {\n  display: block;\n  margin-top: 5px;\n}\n.components-musicListItem.focus {\n  color: #51d306;\n}\n.components-musicListItem:hover {\n  font-size: 18px;\n}\n", ""]);
...
var _Scrollbars = __webpack_require__(85);
...
var _raf2 = __webpack_require__(86);
...
var _getScrollbarWidth = __webpack_require__(95);

var _getScrollbarWidth2 = _interopRequireDefault(_getScrollbarWidth);

var _returnFalse = __webpack_require__(96);

var _returnFalse2 = _interopRequireDefault(_returnFalse);

var _getInnerWidth = __webpack_require__(97);

var _getInnerWidth2 = _interopRequireDefault(_getInnerWidth);

var _getInnerHeight = __webpack_require__(98);

var _getInnerHeight2 = _interopRequireDefault(_getInnerHeight);

var _styles = __webpack_require__(99);

var _defaultRenderElements = __webpack_require__(100);
...
var space = __webpack_require__(91)
...
var clean = __webpack_require__(92)
...
function mapDispatchToProps(dispatch) {
    return {
        changeDuration: function changeDuration(duration) {
            dispatch((0, _player.changeDuration)(duration));
        },
        next: function next() {
            dispatch((0, _player.next)());
        },
        progressChange: function progressChange(progress) {
            dispatch((0, _player.progressChange)(progress));
        }
    };
}
var AppCon = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_app2.default);

exports.default = AppCon;
...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            ...
            $('#player').bind($.jPlayer.event.loadedmetadata, function (e) {
                _this2.props.changeDuration(e.jPlayer.status.duration);
            });
            $('#player').bind($.jPlayer.event.ended, function (e) {
                _this2.props.next();
            });
            $('#player').bind($.jPlayer.event.timeupdate, function (e) {
                _this2.props.progressChange(e.jPlayer.status.currentPercentAbsolute);
            });
        }
    }, {
        key: 'render',
...
function Header(props) {
    return _react2.default.createElement(
        'div',
        { className: 'components-header clearfix' },
        _react2.default.createElement('img', { src: '/image/logo.png', alt: '', width: '40', className: '-col-auto' }),
        _react2.default.createElement(
            'h1',
            { className: 'caption' },
            'React Music Player'
